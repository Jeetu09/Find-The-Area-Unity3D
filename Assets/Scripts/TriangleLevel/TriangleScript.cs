...
public class TriangleScript : MonoBehaviour, IInteractable
{
    [Header("Audio")]
    ...
    [Header("Animation")]
    public Animator TriangleGateUnlocked; // Reference to the Animator component
    public string animationTriggerName = "PlayAnimation"; // Name of the animation trigger\
    public Animator CircleGateUp; // Reference to the Animator component
    public string CircleGateUpTrgr = "PlayAnimation"; // Name of the animation trigger\
    ...
    public GameObject RectangleRoomDia; // UI to be displayed when interacting
    public GameObject TrieangleRoomToCircleRoomDia; // UI to be displayed when interacting
    ...
    public void InteractRange()
    {
        ...
        TraiangleRoomDia.SetActive(false);
    ...
    private void ValidateInputs(string input)
    {
        ...
        {
            int Height = 6;
            int bradth =  randomNumberDisplay.randomNumber;
            double div = 0.5;
            int correctAnswer = (int)(div * Height * bradth);
    ...
    private void SaveDetailsAndAnimate()
    {
        if (targetRenderer != null)
        {
            ...
            TraiangleRoomDia.SetActive(false);
            TrieangleRoomToCircleRoomDia.SetActive(true);

            if (TriangleGateUnlocked != null)
            {
                TriangleGateUnlocked.SetTrigger(animationTriggerName); // Play the animation via the trigger
            ...
            if (CircleGateUp != null)
            {
                CircleGateUp.SetTrigger(CircleGateUpTrgr); // Play the animation via the trigger
                Debug.LogError("Gate is Opening broo");
            }
